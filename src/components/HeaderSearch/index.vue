<template>
  <div class="header-search">
    <SvgIcon class-name="search-icon" name="search" @click.stop="click" />
    <el-dialog v-model="open" width="500" :append-to-body="true" @close="close">
      <el-select
        style="width: 100%"
        ...
        <el-option
          ...
          <span style="float: right" @click.stop="handleLove(option.item)">
            <SvgIcon color="#ccc" name="star"
          /></span>
        </el-option>
      </el-select>
    </el-dialog>
