    ...
    <div class="v3c-content" v-show="tabActive == 4">
      ...
      <el-form-item>
        <el-radio label="3" v-model="state.day.cronEvery">
          ...
          <el-input-number
            v-model="state.day.cycle02"
            :min="state.day.cycle01 ? state.day.cycle01 + 1 : 2"
            :max="31" />
          日
        </el-radio>
      </el-form-item>
      ...
      <el-form-item>
        <el-radio label="4" v-model="state.day.cronEvery">
          ...
          <el-input-number
            ...
            :min="1"
            :max="31 - state.day.incrementStart || 1" />
          日执行一次
        </el-radio>
      </el-form-item>
      <!-- 5 -->
      ...
      <!-- 6 -->
      <el-form-item>
        <el-radio label="6" v-model="state.day.cronEvery">
          在这个月的最后一天
        </el-radio>
      </el-form-item>
      <!-- 7 -->
    ...
    <div class="v3c-content" v-show="tabActive == 7">
        ...
        <el-radio v-model="state.week.cronEvery" label="3">
          ...
          <el-select
            ...
            <el-option
              ...
              :label="item.value"
              :value="item.key"
              :disabled="item.key < state.week.cycle01 && item.key !== 1">
              {{ item.value }}
            </el-option>
          </el-select>
        </el-radio>
      ...
      <el-form-item>
        <el-radio v-model="state.week.cronEvery" label="4">
          第
          <el-input-number v-model="state.week.average01" :min="1" :max="4" />
          周的星期
          <el-select
            clearable
            v-model="state.week.average02"
            style="width: 100px">
            <el-option
              v-for="(item, index) of weekList"
              :key="index"
      ...
      <div class="mt-20">
        <label for="month2">
          ...
          <el-input-number
            ...
            :min="1"
            :max="12 - state.month.incrementStart || 0" />
          月月执行一次
        </label>
      </div>
      <!-- 3 -->
      ...
      <div class="mt-20">
        <label for="month4">
          ...
          <el-input-number
            ...
            :min="state.month.rangeStart ? state.month.rangeStart + 1 : 2"
            :max="12" />
          月
        </label>
      </div>
      ...
      <div class="mt-20">
        <label for="year3">
          ...
          <el-input-number
            ...
            :min="
              state.year.rangeStart ? state.year.rangeStart + 1 : currYear + 1
            "
            :max="currYear + 10" />
        </label>
      </div>
